...
class AuthenticationsControllerTest < ActionController::TestCase
  ...
  test "should create authentication" do
    assert_difference('Authentication.count') do
      post :create, authentication: { access_token: @authentication.access_token, instagram_id: @authentication.instagram_id, user_id: @authentication.user_id }
    end
  ...
  test "should update authentication" do
    patch :update, id: @authentication, authentication: { access_token: @authentication.access_token, instagram_id: @authentication.instagram_id, user_id: @authentication.user_id }
    assert_redirected_to authentication_path(assigns(:authentication))
  end
